import type {
  ...
  ProductProfileAccountNumberField,
  ProductProfileAccountStringField,
...
const ACCOUNT_NUMBER_FIELDS: Array<[ProductProfileAccountNumberField, readonly string[]]> = [
  ...
  ['collectionYellowStars', ['collectionYellowStars', 'collection_yellow_stars', 'collectible.yellow_star_total']],
...
export function buildProductImportFieldSummary(
  ...
  const accountFields: Array<[keyof ProductProfileAccountImport, string, boolean?]> = [
    ...
    ['collectionStars', 'Collection red stars'],
    ['collectionYellowStars', 'Collection yellow stars'],
