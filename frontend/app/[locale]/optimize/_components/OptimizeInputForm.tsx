    ...
    <section className="space-y-6">
      <div>
        ...
        <select
          ...
          className="min-h-[44px] w-full rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-3 py-2.5 font-mono text-sm text-[color:var(--color-text)] focus:border-[color:var(--color-primary)]"
        >
        ...
        <div className="mb-2 flex items-baseline justify-between">
          ...
          <div className="flex items-center gap-2 text-xs">
            <button
              ...
              className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center px-3 py-2 text-[color:var(--color-primary)] hover:underline sm:hidden"
            ...
            <button
              ...
              className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center px-3 py-2 text-[color:var(--color-primary)] hover:underline"
            >
              all
            </button>
          ...
          {COLLECTIBLES.map((c) => {
            ...
            return (
              <button
                ...
                role="switch"
                aria-checked={owned}
                aria-label={`${String(c.id + 1).padStart(2, '0')} ${c.name}`}
                onClick={() => onToggleCollectible(c.id)}
                className={
                  "relative min-h-[44px] min-w-[44px] rounded border px-1.5 py-1.5 font-mono text-[10px] transition before:absolute before:inset-[-10px] before:content-[''] " +
                  (owned
          ...
          {EQUIPMENT_SLOTS.map((slot) => (
            <div key={slot.id} className="flex items-center gap-3">
              ...
              <select
                ...
                className="min-h-[44px] flex-1 rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-3 py-2 font-mono text-sm text-[color:var(--color-text)]"
              >
      ...
      <div data-testid="pet-section">
        ...
        <select
          ...
          className="min-h-[44px] w-full rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-3 py-2.5 font-mono text-sm text-[color:var(--color-text)]"
        >
